              ...
              <>
                ...
                <div className="flex items-center gap-3">
                  <Avatar className="h-8 w-8">
                    <AvatarImage
                      src={user?.userImage ? `http://localhost:5000${user.userImage}` : undefined}
                      alt={user?.userName}
                    />
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-64">
                <nav className="flex flex-col gap-4 mt-8">
                  ...
                  <Link
                    to="/about"
                    className={`text-lg font-medium transition-colors hover:text-primary px-4 py-2 rounded-md ${isActive('/about') ? 'bg-muted text-primary' : 'text-muted-foreground'}`}
                  >
                    About
                  </Link>
                  <Link
                    to="/feedback"
                    className={`text-lg font-medium transition-colors hover:text-primary px-4 py-2 rounded-md ${isActive('/feedback') ? 'bg-muted text-primary' : 'text-muted-foreground'}`}
                  >
                    Feedback
                  </Link>
                  {currentUserStr && (
