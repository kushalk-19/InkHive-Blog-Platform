  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        ...
        const allRes = await axios.get('https://inkhive-backend.onrender.com/api/users/blogs');
        const allBlogs = allRes.data;

        // 2. Get ONLY 4 featured blogs with correct blogID for carousel
        const featuredRes = await axios.get('https://inkhive-backend.onrender.com/api/users/blogs/featured');
