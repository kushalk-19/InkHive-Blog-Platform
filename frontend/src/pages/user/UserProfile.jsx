    ...
    useEffect(() => {
        const fetchUserAndBlogs = async () => {
            try {
                ...
                const userRes = await axios.get(`https://inkhive-backend.onrender.com/api/users/profile/${userId}`);
                setUser(userRes.data);

                // Step 2: Get all approved blogs by this user
                const blogsRes = await axios.get(`https://inkhive-backend.onrender.com/api/users/blogs/by-user/${userId}`);
