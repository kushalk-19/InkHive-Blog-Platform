...
const SingleBlog = () => {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        const res = await axios.get(`https://inkhive-backend.onrender.com/api/users/blogs/${id}`);
        const data = res.data;
  ...
  const handleLike = async () => {
    ...
    try {
      const res = await axios.post(
        `https://inkhive-backend.onrender.com/api/users/blogs/${id}/like`,
        {},
  ...
  const handleDeleteComment = async (commentId) => {
    try {
      await axios.delete(`https://inkhive-backend.onrender.com/api/users/blogs/${id}/comment/${commentId}`, {
        withCredentials: true
      });
