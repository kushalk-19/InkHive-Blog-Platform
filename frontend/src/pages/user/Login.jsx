...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (currentUser || document.cookie.includes('userJWTToken')) {
      ...
      axios.post('https://inkhive-backend.onrender.com/api/users/logout', {}, { withCredentials: true })
        .then(() => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post('https://inkhive-backend.onrender.com/api/users/login', {
        userEmail: email,
