...
const ManageBlogRequests = () => {
  ...
  useEffect(() => {
    ...
    const fetchPendingBlogs = async () => {
      try {
        const res = await axios.get('https://inkhive-backend.onrender.com/api/users/blogs/admin/pending', {
  ...
  const handleApprove = async (id) => {
    try {
      await axios.put(`https://inkhive-backend.onrender.com/api/users/blogs/admin/${id}/approve`, {}, {
        withCredentials: true
      });
  ...
  const handleReject = async (id) => {
    try {
      await axios.put(`https://inkhive-backend.onrender.com/api/users/blogs/admin/${id}/reject`, {}, {
        withCredentials: true
      });
      setRequests(prev => prev.filter(r => r.id !== id));
          ...
          <DialogContent className="max-w-4xl max-h-screen overflow-y-auto">
            ...
            <div className="grid gap-6 py-4">
              ...
              {selectedBlog?.blogImage && (
                <div>
                  <img
                    src={`https://inkhive-backend.onrender.com${selectedBlog.blogImage}`}
